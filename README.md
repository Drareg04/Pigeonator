# 🕊️ Pigeonator  
*Your all-in-one, no-install creative toolbox — straight from the digital coop!*
...
| Feature | Description |
|---------|-------------|
| 🖼️ **Image Editing** | Crop, filter, rotate, tweak colors, add text, stack layers — a mini Photoshop in your browser. |
